...
\begin{table}[H]
   ...
   \begin{tabular}{ccc}
     ...
     \includegraphics[scale=0.3]{../results/p0.9_seed10/img/Z1.pdf} &
     \includegraphics[scale=0.3]{../results/p0.95_seed9/img/Z1.pdf} \\
     (d) $\hat Z_2, p=0.85$ &
     (e) $\hat Z_2, p=0.90$ &
     (f) $\hat Z_2, p=0.95$ \\
     \includegraphics[scale=0.3]{../results/p0.85_seed1/img/Z2.pdf} &
     \includegraphics[scale=0.3]{../results/p0.9_seed10/img/Z2.pdf} &
     \includegraphics[scale=0.3]{../results/p0.95_seed9/img/Z2.pdf} \\
     (g) $\hat Z_3, p=0.85$ &
     (h) $\hat Z_3, p=0.90$ &
     (i) $\hat Z_3, p=0.95$ \\
     \includegraphics[scale=0.3]{../results/p0.85_seed1/img/Z3.pdf} &
     \includegraphics[scale=0.3]{../results/p0.9_seed10/img/Z3.pdf} &
     \includegraphics[scale=0.3]{../results/p0.95_seed9/img/Z3.pdf} \\
   \end{tabular}
   \label{tab:psens1}
